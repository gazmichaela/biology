  ...
  class StickyDropdownManager {
    constructor(options = {}) {
      ...
      this.config.storageKeys = {
       ...
       /* mouseOver: `${this.config.storagePrefix}-mouseOver`,*/
      };
    ...
    _clearStorageKeys() {
      /*localStorage.removeItem(this.config.storageKeys.mouseOver);*/
      localStorage.removeItem(this.config.storageKeys.isSubMenuOpen);
    }
  ...
  if (mainButton) {
    ...
    _onDocumentMouseMove(e) {
     /* const now = Date.now();*/
      ...
      /*if (now - this.state.lastMouseUpdate > 100) this.state.lastMouseUpdate = now;*/
  ...
  class StickyHeader {
    constructor(options = {}) {
      this.config = {
        ...
        localStorageKeysToClean: options.localStorageKeysToClean || [
          "sticky-dropdown-content-mouseOver",
          "sticky-dropdown-content-second-mouseOver",
          "sticky-dropdown-content-third-mouseOver",
        ],
      };
      ...
      /*this.wasStickyActuallyVisible = false;*/
    ...
    _cleanLocalStorage() {
      this.config.localStorageKeysToClean.forEach((key) => localStorage.removeItem(key));
    }
